...
-- Description: Populates the database with realistic dummy data for development and testing.
-- Note: Prices are stored as raw integer VND (e.g., 900000 for 900k VND).

-- Clean existing data to allow re-seeding (ordered to respect foreign keys)
...
-- 3. Events
-- Note: price_vnd is stored as raw integer (e.g., 500000 for 500.000 VND)
INSERT INTO events (id, organizer_id, slug, name, category, description, included, area, lat, lng, starts_at, price_vnd, capacity, palette, greeting, visibility, approval, hold_minutes, status, created_at) VALUES
('evt_001', 'org_001', 'react-summit-2024', 'React Summit 2024', 'Technology', 'A gathering of React enthusiasts and experts to discuss the future of frontend development.', 'Lunch, Swag Bag, Certificate', 'Ho Chi Minh City', 10.8231, 106.6297, '2024-10-15 09:00:00+07', 500000, 500, 'blue', 'Welcome to React Summit 2024! We are excited to have you join us.', 'public', 'instant', 30, 'live', now()),
...
('evt_003', 'org_002', 'saigon-food-tour', 'Saigon Food & Walking Tour', 'Food & Travel', 'Explore the hidden culinary gems of District 1, Ho Chi Minh City with a local guide.', 'Food tastings, Local guide', 'Ho Chi Minh City', 10.7769, 106.7009, '2024-09-28 14:00:00+07', 300000, 30, 'orange', 'Join us for an unforgettable culinary journey through Saigon.', 'public', 'instant', 15, 'draft', now()),
('evt_004', 'org_002', 'da-lat-adventure-weekend', 'Da Lat Adventure Weekend', 'Travel', 'A weekend getaway in Da Lat featuring hiking, coffee tasting, and outdoor games.', 'Accommodation, Breakfast, Activities', 'Da Lat', 11.9407, 108.4452, '2024-12-07 08:00:00+07', 900000, 80, 'green', 'Escape the hustle of the city and enjoy a refreshing weekend in Da Lat.', 'invite', 'instant', 30, 'live', now());

-- 4. Event Photos (Mock paths)
